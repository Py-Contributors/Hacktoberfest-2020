...
### Disclaimer :- This repository is for learning purpose, how to create issues and pull requests on Hithub during Hacktoberfest.
...
Support open source and earn a limited edition T-shirt! <br/>
...
Hacktoberfest is open to everyone in our global community. Whether you’re a developer, student learning to cod, you can contribute to anything from code to simple fix, new feature to fixing a grammar mistake.
...
You can contribute to any open source project hosted on Github and contribute anything between October 1 to October 31 midnight in 2020. You will find plenty of issues labeled with `hacktoberfest` or `good-first-issue` etc on Github. These will most probably be the simple ones and easy to fix.
